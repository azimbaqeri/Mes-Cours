...
function App() {
  ...
  return (
    <>
      ...
      <input type="text" className='search' value={searchTerm} placeholder="Rechercher un film..." onChange={(e) => setSearchTerm(e.target.value)} onSubmit={handleSearch} />
      <div>
        ...
        <div className="movie-list">
          {movies.map((movie) => (
            <div
              ...
              onClick={() => navigate(`/MovieDetails/${movie.id}`, { state: { movie, movies, searchTerm } })}
            >
